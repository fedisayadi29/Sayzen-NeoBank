...
router.patch('/kyc-documents/:id/review', ctrl.reviewKycDocument);
router.get('/notifications',              ctrl.getAdminNotifications);
router.patch('/notifications/read-all',   ctrl.markAllAdminNotifsRead);
router.patch('/notifications/:id/read',   ctrl.markAdminNotifRead);
